...
def run_test_problem1a():
    ...
    expected = 0.8658
    print_expected_result_of_test([50, 80], expected, test_results,
                                  format_string)
    actual = problem1a(50, 80)
    print_actual_result_of_test(expected, actual, test_results, precision=3)

    print_summary_of_test_results(test_results)

    expected = -1.979
    print_expected_result_of_test([100, 150], expected, test_results,
                                  format_string)
    actual = problem1a(100, 150)
    print_actual_result_of_test(expected, actual, test_results, precision=3)
